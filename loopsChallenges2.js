...
let cityNewPopulations = {}      // Empty object 


for(const Rytham in citiesPopulation){
   ...
   // key = value
   cityNewPopulations[Rytham] = citiesPopulation[Rytham]
}
...
let availableTeas = [];
let stop = false;       // flag, that will check ki "chai" is found or not



teaCollection.forEach(tea => {

   if(stop === true){         // agar stop true hai toh, skip karta reh
      return;
   }
   if(tea === "chai"){        // Chai mil gayi, stop ko true karde and skip
      stop = true;
      return;
   }
